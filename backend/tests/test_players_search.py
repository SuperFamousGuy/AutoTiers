"""Tests for GET /api/players/search?q=<name> and GET /api/players/batch.

Anonymous (no accounts). Returns matching players (id, name, position, team),
capped at 25 results for search and 20 ids for batch.
"""
import pytest
